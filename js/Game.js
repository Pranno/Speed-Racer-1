class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 200, y: height - 1400, image: obstacle2Image },
      { x: width / 2 + 300, y: height - 1900, image: obstacle2Image },
      { x: width / 2 - 280, y: height - 3400, image: obstacle2Image },
     
      { x: width / 2 - 200, y: height - 4400, image: obstacle2Image },
      { x: width / 2, y: height - 5400, image: obstacle2Image },
    ]
